...
class RegresionLineal:
    '''
    Clase que implementa la regresión lineal o polinomial de grado 2. Los datos ser reciben como un arreglo de numpy de tamaño:
        num_points x 2
    La clase calcula los coeficientes de la recta o la parabola, además, puede graficarlos y dar las métricas de error.
    '''
    ...
    def metrics(self):
        S_t = np.sum((self.datos[:,1]-np.mean(self.datos,axis=0)[1])**2)
